...
void addPair(char* key, int value, hashTable hTable) {
	hTable.loadFactor = insertPair(key, value, hTable.table, hTable.tableSize, hTable.loadFactor);		// table ok???
...
void deletePair(char* key, hashTable hTable) {
	hTable.loadFactor = removePair(key, hTable.table, hTable.tableSize, hTable.loadFactor);		// table ok???
